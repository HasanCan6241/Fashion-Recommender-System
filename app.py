...
# Streamlit başlık ve tema
st.set_page_config(page_title="Fashion Recommender System", layout="wide")
st.title("Fashion Recommender System")
st.markdown("""
    **Upload an image of clothing to get similar clothing recommendations!**
""")

# Yüklenen dosyayı kaydetme fonksiyonu
